...
The `apps/macos/ChatUIPlayground` app provides a live development environment:

1. Open `ChatUIPlayground.xcodeproj` in Xcode
2. Build and run the app (⌘R)
3. Browse components in the sidebar
4. See live examples and interact with components
...
2. Enter the local path: `../../../packages/ui-swift`
...
```swift
dependencies: [
    .package(path: "../packages/ui-swift")
],
targets: [
    .target(
        name: "YourTarget",
