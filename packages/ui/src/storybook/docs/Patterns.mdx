...
<Canvas>
  <Story name="Action Bar">
    <ChatUIRoot>
      <div className="p-4">
        <div className="flex items-center gap-2 p-3 bg-foundation-bg-light-2 dark:bg-foundation-bg-dark-2 rounded-lg">
      ...
      <div className="p-4 max-w-sm">
        <div className="space-y-1">
          <ListItem
            ...
            active
            action={
              <IconButton icon={<span>⋯</span>} variant="ghost" size="sm" title="More actions" />
            }
          >
            <div>
          ...
          <ListItem icon={<span>📝</span>} onClick={() => {}}>
            Start New Chat
          </ListItem>
      ...
      return (
        <ChatUIRoot>
          <div className="p-4 space-y-3">
            <h3 className="text-foundation-text-light-primary dark:text-foundation-text-dark-primary font-medium">
              Active Context
            </h3>
...
## 💬 Chat Layout Variants

Compose chat surfaces with slot-based variants:
          ...
          messages={[
            {
              id: "1",
              role: "assistant",
              content: "Slot-based layout keeps UI consistent across platforms.",
              timestamp: new Date(),
            },
          ]}
