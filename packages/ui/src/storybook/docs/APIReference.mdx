...
import * as APIReferenceStories from "./APIReference.stories";

<Meta of={APIReferenceStories} />
    ...
    {() => {
      ...
      return (
        <div className="p-4 space-y-6">
          <div>
            <label className="text-foundation-text-light-secondary dark:text-foundation-text-dark-secondary text-sm mb-2 block">
              Quality
            </label>
            <SegmentedControl
              value={quality}
...
<Canvas>
  <Story name="MessageActions API">
    <div className="p-4">
      <div className="bg-foundation-bg-light-2 dark:bg-foundation-bg-dark-2 p-4 rounded-lg max-w-md">
...
```tsx
<Button className="bg-foundation-accent-purple text-accent-foreground hover:bg-foundation-accent-purple/90">
  Custom Button
</Button>
```
