/**
 * InputIcons - Icons used in ChatInput component
 *
 * Extracted from ChatInput.tsx for better code organization
 */
...
export function IconTelescope({ className }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
