  ...
  return (
    ...
    >
      <div
        ...
        className="bg-foundation-bg-light-1 dark:bg-foundation-bg-dark-1 rounded-[16px] w-[560px] max-h-[85vh] overflow-hidden shadow-2xl border border-foundation-text-light-primary/10 dark:border-foundation-text-dark-primary/10 outline-none"
                ...
                <div className="space-y-0.5">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="w-full flex items-center justify-between px-3 py-2.5 hover:bg-foundation-bg-light-2 dark:hover:bg-foundation-bg-dark-2 rounded-lg transition-colors">
