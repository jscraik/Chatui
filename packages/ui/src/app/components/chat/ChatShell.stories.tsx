...
import { ChatVariantCompact, ChatVariantContextRail, ChatVariantSplitSidebar } from "./chat-variants";
import {
  sampleCategories,
  ...
  args: {
    ...
    contextPanel: (
      <div className="p-4 space-y-3">
        ...
        <div className="rounded-lg border border-foundation-bg-light-3 dark:border-foundation-bg-dark-3 p-3 text-sm text-foundation-text-light-secondary dark:text-foundation-text-dark-secondary">
