                  ...
                  leading={(
                    <>
                      ...
                      <div className="ml-1 px-2 py-1 bg-foundation-bg-light-2 dark:bg-foundation-bg-dark-2 rounded-md">
                        <span className="text-[11px] leading-4 text-foundation-text-light-primary dark:text-foundation-text-dark-primary font-medium">
                  ...
                  trailing={(
                    <>
                      ...
                      <button
                        ...
                        type="button"
                        className="w-6 h-6 rounded-full bg-foundation-accent-green-light dark:bg-foundation-accent-green ml-1 flex items-center justify-center hover:bg-foundation-accent-green-light/90 dark:hover:bg-foundation-accent-green/90 transition-colors"
                      >
                        <svg
                          className="size-3 text-foundation-text-dark-primary dark:text-foundation-text-light-primary"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          strokeWidth={2.5}
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              >
                                <span className="flex items-center gap-1.5">
                                  <span className="rounded-sm bg-foundation-accent-green/20 px-1 text-foundation-text-light-primary dark:text-foundation-text-dark-primary">
                                    {targetSize}k
                                  </span>
