import { IconBook, IconChevronRightMd, IconInfo, IconQuestion, IconUserLock, IconWarning } from "../../../../icons/ChatGPTIcons";
    ...
    <div className="mb-5">
      ...
      <div className="space-y-0.5">
        ...
        <SettingRow
          ...
          right={<span className="text-body-small font-normal text-foundation-text-dark-secondary">{appInfo?.versionLabel ?? "—"}</span>}
        />
        <SettingRow
          label="Log out"
          right={<IconChevronRightMd className="size-4 text-foundation-icon-light-tertiary dark:text-foundation-icon-dark-tertiary" />}
