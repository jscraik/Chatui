import { IconArchive, IconCategory, IconCreditCard, IconEmail, IconPhone, IconStarFilled, IconStatus, IconSuitcase, IconUserLock, IconChevronRightMd } from "../../../../icons/ChatGPTIcons";
    ...
    <div className="mb-5">
      ...
      <div className="space-y-0.5">
        <SettingRow
          ...
          label="Email"
          right={<span className="text-body-small font-normal text-foundation-text-dark-secondary">{account?.email ?? "—"}</span>}
        />
        <SettingRow
          icon={<IconPhone className="size-4 text-foundation-icon-light-secondary dark:text-foundation-icon-dark-secondary" />}
          label="Phone number"
          right={<span className="text-body-small font-normal text-foundation-text-dark-secondary">{account?.phone ?? "—"}</span>}
        />
        <SettingRow
          icon={<IconCreditCard className="size-4 text-foundation-icon-light-secondary dark:text-foundation-icon-dark-secondary" />}
          label="Subscription"
          right={<span className="text-body-small font-normal text-foundation-text-dark-secondary">{account?.subscriptionLabel ?? "—"}</span>}
        />
        <SettingRow
