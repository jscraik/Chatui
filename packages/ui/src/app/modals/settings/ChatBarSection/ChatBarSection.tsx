import { IconChevronDownMd, IconMessaging, IconTerminal, IconUndo } from "../../../../icons/ChatGPTIcons";
    ...
    <div className="mb-5">
      ...
      <div className="space-y-0.5">
        <SettingRow
          ...
          right={
            <div className="flex items-center gap-2">
              <span className="text-body-small font-normal text-foundation-text-dark-secondary">{positionOnScreen}</span>
        ...
        <SettingRow
          ...
          right={
            <div className="flex items-center gap-2">
              <span className="text-body-small font-normal text-foundation-text-dark-secondary">{resetToNewChat}</span>
              <div className="size-5 rounded-full bg-foundation-bg-dark-3 flex items-center justify-center">
                <IconChevronDownMd className="size-3 text-foundation-icon-light-secondary dark:text-foundation-icon-dark-secondary" />
              </div>
            </div>
        ...
        <SettingRow
          ...
          right={
            <div className="flex items-center gap-2">
              <span className="text-body-small font-normal text-foundation-text-dark-secondary">{keyboardShortcut}</span>
              <button
                type="button"
        ...
        <SettingRow
          ...
          right={
            <div className="flex items-center gap-2">
              <span className="text-body-small font-normal text-foundation-text-dark-secondary">In Companion Chat</span>
              <div className="size-5 rounded-full bg-foundation-bg-dark-3 flex items-center justify-center">
                <IconChevronDownMd className="size-3 text-foundation-icon-light-secondary dark:text-foundation-icon-dark-secondary" />
              </div>
            </div>
