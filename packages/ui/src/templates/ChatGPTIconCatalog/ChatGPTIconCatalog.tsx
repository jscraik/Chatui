  ...
  return (
    <div className="min-h-screen bg-foundation-bg-dark-1">
      <div className="mx-auto max-w-7xl p-8">
        ...
        {/* Controls */}
        <div className="mb-8 rounded-xl border border-foundation-divider-dark p-6 space-y-4 bg-foundation-bg-dark-2">
          {/* Search */}
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-foundation-divider-dark bg-foundation-bg-dark-1 text-foundation-text-dark-primary focus:outline-none focus:ring-2 focus-foundation-accent-dark-green"
            />
          </div>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                    selectedCategory === category
                      ? 'bg-foundation-accent-dark-green text-foundation-accent-dark-foreground'
                      : 'bg-foundation-bg-dark-1 text-foundation-text-dark-secondary hover:text-foundation-text-dark-primary'
                  }`}
                >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
          {displayedIcons.map(([name, IconComponent]) => {
            ...
            return (
              <div
                key={name}
                className="group rounded-xl p-4 border border-foundation-divider-dark bg-foundation-bg-dark-2 hover:shadow-lg transition-all cursor-pointer"
                onClick={() => {
        ...
        {displayedIcons.length === 0 && (
          <div className="text-center py-12 rounded-xl border border-foundation-divider-dark bg-foundation-bg-dark-2">
        ...
        {/* Footer Info */}
        <div className="mt-12 p-6 rounded-xl border border-foundation-divider-dark bg-foundation-bg-dark-2">
          ...
          <div className="space-y-2 text-sm font-mono text-foundation-text-dark-secondary">
            <p>
              <span className="text-foundation-accent-dark-green">import</span> {`{ IconCheckmark }`} <span className="text-foundation-accent-dark-green">from</span> {'"@chatui/ui/icons"'};
            </p>
