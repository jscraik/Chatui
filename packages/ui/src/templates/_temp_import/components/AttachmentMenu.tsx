            ...
            <Popover.Portal>
              ...
              >
                ...
                <MenuItem onClick={() => handleMoreAction("study-learn")}>
                  <svg
                    className="size-5 text-foundation-text-light-secondary dark:text-foundation-text-dark-secondary group-hover:text-foundation-text-light-primary dark:group-hover:text-foundation-text-dark-primary transition-colors"
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={1.5}
                    stroke="currentColor"
                    ...
                    <IconPublic
                      className={cn(
                        ...
                        isWebSearchActive
                          ...
                          : "text-foundation-text-light-secondary dark:text-foundation-text-dark-secondary group-hover:text-foundation-text-light-primary dark:group-hover:text-foundation-text-dark-primary",
                      )}
                    />
                ...
                <MenuItem onClick={() => handleMoreAction("explore-apps")}>
                  <IconSearch className="size-5 text-foundation-text-light-secondary dark:text-foundation-text-dark-secondary group-hover:text-foundation-text-light-primary dark:group-hover:text-foundation-text-dark-primary transition-colors" />
