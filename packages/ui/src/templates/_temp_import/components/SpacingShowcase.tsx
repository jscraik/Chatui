    ...
    <div className="rounded-xl p-4 bg-foundation-bg-dark-2 border border-foundation-text-dark-primary/10">
      ...
      {showBox && (
        <div className="bg-foundation-bg-dark-3 rounded flex items-center justify-center">
          <div
            className="bg-foundation-accent-blue"
        ...
        <div className="rounded-xl p-6 bg-foundation-bg-dark-2 border border-foundation-text-dark-primary/10 space-y-4">
          {spacingEntries.slice(1).map(([token, value]) => (
            <div key={token} className="flex items-center gap-4">
              ...
              <div
                className="bg-foundation-accent-green h-8 rounded"
                style={{ width: value }}
              />
              <div className="text-xs text-foundation-text-dark-secondary">
                {value}
              </div>
            </div>
          ))}
        ...
        <div className="rounded-xl p-6 bg-foundation-bg-dark-2 border border-foundation-text-dark-primary/10 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="text-body-small text-foundation-text-dark-secondary">
                Use <code className="text-foundation-accent-blue">space-16</code> (32px) for component spacing
              </div>
            </div>
            <div>
              <div className="text-sm font-semibold text-foundation-text-dark-primary mb-2">
              ...
              <div className="text-body-small text-foundation-text-dark-secondary">
                Use <code className="text-foundation-accent-blue">space-8</code> (16px) for element spacing
              </div>
            </div>
            <div>
              <div className="text-sm font-semibold text-foundation-text-dark-primary mb-2">
              ...
              <div className="text-body-small text-foundation-text-dark-secondary">
                Use <code className="text-foundation-accent-blue">space-4</code> (8px) for tight spacing
              </div>
            </div>
          </div>
        </div>
