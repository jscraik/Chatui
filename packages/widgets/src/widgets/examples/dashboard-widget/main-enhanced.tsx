...
import type { DashboardToolOutput } from "../../../shared/tool-output-types";
...
// Core dashboard component (unchanged logic)
...
// Enhanced widget with error boundary and consistent styling
    ...
    <WidgetErrorBoundary>
      <HostProvider host={host}>
        <AppsSDKUIProvider linkComponent="a">
          {/* No WidgetBase wrapper here since DashboardPage handles its own layout */}
          <DashboardCore />
        </AppsSDKUIProvider>
      </HostProvider>
    </WidgetErrorBoundary>
...
export { DashboardCore, DashboardWidget };
