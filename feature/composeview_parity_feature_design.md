...
const meta: Meta<typeof ComposeWidgetView> = { title: "Widget/Compose", component: ComposeWidgetView };
export default meta;
...
- packages/ui/src/app/components/chat/ComposeView.tsx (reference: web parity target)
- packages/ui/src/app/components/chat/ComposeWidgetView.tsx (new widget view)
- apps/web/src/WidgetHarness.tsx (add widget entry)
- apps/web/src/widgets/compose-widget/index.html (new widget mount, if using existing widget harness pattern)
- apps/web/src/widgets/compose-widget/main.tsx (widget entry)
- apps/storybook/src/stories/ComposeWidgetView.stories.tsx
- swift/ChatUIComponents/Sources/ChatUIComponents/ComposeViewSwiftUI.swift
- swift/ChatUIComponents/Sources/ChatUIComponents/ComposeViewController.swift (AppKit wrapper)
- packages/tokens/src (add size/icon/border tokens if you want strict parity without ad-hoc values)
- swift/ChatUIFoundation/Sources/ChatUIFoundation/DesignTokens.swift (regenerate for new tokens if added)
