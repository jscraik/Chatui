...
`apps/macos/ChatUIPlayground` now uses the modular Swift packages. It is no longer wired to `swift/ui-swift`.
...
2. Enter the local path: `../../../swift/ui-swift`
