...
public enum DesignTokens {
    ...
    public enum Accessibility {
        ...
        public static let focusRing = Color.accentColor
        
        /// High contrast variants
        public enum HighContrast {
            public static let textOnBackground = Color.primary
            public static let backgroundContrast = Color.secondary
        }
        ...
        public enum Animation {
            ...
            public static func duration(respectingMotionPreference: Bool) -> Double {
                return respectingMotionPreference ? reducedDuration : duration
            }
        }
    }
}
