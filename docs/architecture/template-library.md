...
- SwiftUI templates + blocks: `swift/ChatUIComponents/Sources/ChatUIComponents/Templates`
- SwiftUI registry: `swift/ChatUIComponents/Sources/ChatUIComponents/Templates/TemplateRegistry.swift`
- Widgets: `packages/widgets/src/*` (each widget renders a template from `@chatui/ui/templates`)
