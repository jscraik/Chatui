...
public class NotificationManager: NSObject {
    ...
    static var isAvailableForCurrentProcess: Bool {
        #if os(macOS)
        let bundleExtension = Bundle.main.bundleURL.pathExtension.lowercased()
        return bundleExtension == "app" || bundleExtension == "xctest"
        #else
        return true
        #endif
    }
    ...
    private func requireCenter() throws -> UNUserNotificationCenter {
