...
final class NotificationManagerTests: XCTestCase {
    ...
    override func setUp() async throws {
        guard NotificationManager.isAvailableForCurrentProcess else {
            throw XCTSkip("UserNotifications is unavailable in the SwiftPM test runner.")
        }
    ...
    func testSendNotification() async throws {
        ...
        _ = await notificationManager.getPendingNotifications()
