...
final class FileSystemManagerTests: XCTestCase {
    ...
    func testResolveBookmark() throws {
        ...
        let resolvedPath = resolvedURL.resolvingSymlinksInPath().standardizedFileURL.path
        let expectedPath = testFile.resolvingSymlinksInPath().standardizedFileURL.path
