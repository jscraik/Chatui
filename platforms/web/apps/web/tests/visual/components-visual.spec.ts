...
import {
  ...
  waitForAnimations,
} from "../../../../../../packages/ui/src/testing/utils/test-mocks";
...
test.describe("SettingsModal visual regression", () => {
  ...
  test("renders settings main view in both themes", async ({ page }) => {
    ...
    const settingsTrigger = page
      .locator('[aria-label="Open settings"], button:has-text("Settings")')
      .first();
...
test.describe("IconPickerModal visual regression", () => {
  ...
  test("renders icon picker in both themes", async ({ page }) => {
    const iconPickerTrigger = page
      .locator('button:has-text("Choose Icon"), button:has-text("Icon Picker")')
      .first();
...
test.describe("ChatSidebar visual regression", () => {
  ...
  test("renders sidebar with active state in both themes", async ({ page }) => {
    ...
    const firstItem = page
      .locator(
        'button:has-text("UI Library"), button:has-text("Apps SDK Demo"), button:has-text("Search Widgets")',
      )
      .first();
...
test.describe("Interactive states visual regression", () => {
  ...
  test("renders active/pressed states in both themes", async ({ page }) => {
    const button = page
      .locator('button[aria-pressed="true"], button:has-text("Active"), button.active')
      .first();
